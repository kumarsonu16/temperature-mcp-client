...
class MCPClient:
    ...
    def __init__(
        self,
        app_name: str = "temperature_mcp_client",
        ...
        # Creates an in-memory session manager for handling user sessions.
        # Initializes an agent wrapper, optionally filtering which tools are available.
        # Declares a variable for the runner (which will execute agent tasks), initially set to None until initialized.
